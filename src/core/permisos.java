...
public class permisos {
	...
	public String generarMenuModulos( String pers_documento ) throws SQLException	{
		...
		ResultSet rs = stmt.executeQuery("select distinct per.pers_id, mod.modu_id, mod.modu_nombre, mod.modu_imagen, apl.apli_ubicacion, mod.modu_ubicacion, mod.modu_orden  " 
